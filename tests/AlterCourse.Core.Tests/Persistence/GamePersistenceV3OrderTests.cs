...
public sealed class GamePersistenceV3OrderTests
{
    ...
    public void RoundTripsCurrentV3WithoutOrders()
    {
        ...
        Assert.Equal(7, normalized["schemaVersion"]!.GetValue<int>());
        Assert.Equal(
    ...
    public void MigratesHistoricalV2TravelWithoutInferringAnOrder()
    {
        ...
        Assert.Equal("faction-intent-autonomous-assignment-v1", current["simulationRulesVersion"]!.GetValue<string>());
