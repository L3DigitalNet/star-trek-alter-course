...
The canonical [Markdown Frontmatter 1.15 standard](https://github.com/L3DigitalNet/project-standards/blob/v5.27.0/standards/markdown-frontmatter/versions/1.15/README.md) is authoritative and wins if this summary conflicts with it.
...
Use the [versioned package documentation](https://github.com/L3DigitalNet/project-standards/tree/v5.27.0/standards/markdown-frontmatter/versions/1.15) for complete requirements.
