...
public static class CommandInterfacePreviewFixtures
{
    ...
    private static ImmutableArray<CommandInterfaceTelemetrySection> TravelTelemetry() =>
        [
            Section(
                "destination",
                "DESTINATION",
    ...
    private static ImmutableArray<CommandInterfaceEventRow> TravelEvents() =>
        [
    ...
    private static ImmutableArray<CommandInterfaceMapItem> TravelMapItems() =>
        [
    ...
    private static ImmutableArray<CommandInterfaceField> CombatHeader() =>
        [
    ...
    private static ImmutableArray<CommandInterfaceTelemetrySection> CombatTelemetry() =>
        [
            Section(
                "selected-contact",
                "SELECTED CONTACT",
    ...
    private static ImmutableArray<CommandInterfaceAction> CombatActions() =>
        [
    ...
    private static ImmutableArray<CommandInterfaceEventRow> CombatEvents() =>
        [
            Event(
                "18:06:51",
                "SENSORS",
    ...
    private static ImmutableArray<CommandInterfaceMapItem> CombatMapItems() =>
        [
            new(
                "enterprise",
    ...
    private static ImmutableArray<CommandInterfaceField> EngineeringHeader() =>
        [
    ...
    private static ImmutableArray<CommandInterfaceTelemetrySection> EngineeringTelemetry() =>
        [
            Section(
                "selected-component",
    ...
    private static ImmutableArray<CommandInterfaceAction> EngineeringActions() =>
        [
    ...
    private static ImmutableArray<CommandInterfaceEventRow> EngineeringEvents() =>
        [
            Event(
                "18:07:29",
                "DAMAGE",
    ...
    private static CommandInterfaceEngineeringPresentation EngineeringFixture() =>
        new(EngineeringHierarchy(), EngineeringComponents(), EngineeringLinks(), EngineeringQueue());

    private static ImmutableArray<CommandInterfaceHierarchyRow> EngineeringHierarchy() =>
        [
    ...
    private static ImmutableArray<CommandInterfaceTelemetrySection> EngineeringComponents() =>
        [
    ...
    private static ImmutableArray<CommandInterfaceEngineeringLink> EngineeringLinks() =>
        [
    ...
    private static ImmutableArray<CommandInterfaceQueueRow> EngineeringQueue() =>
        [
